...
public class GetPaidOrderItemsQueryHandler(IApplicationDbContext dbContext, IReportService reportService) : IRequestHandler<GetPaidOrderItemsQuery, IEnumerable<PaidOrderItemDto>>
{
