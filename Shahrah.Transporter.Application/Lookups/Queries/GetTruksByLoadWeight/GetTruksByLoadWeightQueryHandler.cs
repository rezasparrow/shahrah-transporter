...
public class GetTruksByLoadWeightQueryHandler : IRequestHandler<GetTruksByLoadWeightQuery, IEnumerable<TruckDto>>
{
    private readonly IApplicationDbContext _dbContext;

    public GetTruksByLoadWeightQueryHandler(IApplicationDbContext dbContext)
    {
